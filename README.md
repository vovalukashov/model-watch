...
- `↩️ вернулось` — имя, которого на прошлой проверке не было ни в одном каталоге, но которое там уже бывало, появилось
  снова. Так выглядит релиз после прибранного слива: `gpt-6-sol` пропал из Azure вместе с astra-minor и вернулся к вечеру.
